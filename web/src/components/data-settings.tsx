...
function StorageSettings({ demo, onOpenPersonalization }: { demo: boolean; onOpenPersonalization?: () => void }) {
  const client = useQueryClient();
