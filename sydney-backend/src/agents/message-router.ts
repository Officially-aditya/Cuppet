...
export function routeAgentMessage(
  ...
  if (unsupported) {
    return {
      ...
      patch: {},
      reply: `I can't add ${unsupported} access yet. I can work with the current setup, or you can use Gmail, Calendar, Drive, GitHub, Slack, Notion, web search, reminders, and study-plan style agents as they become available.`
    };
  }
